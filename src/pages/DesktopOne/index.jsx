      ...
      <div className="bg-black-900 flex flex-col font-inter items-center justify-start mx-auto overflow-auto w-full">
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <div className="flex flex-col items-center justify-start w-full">
            ...
            <div className="h-[1024px] md:px-5 relative w-full">
        ...
        <div className="flex flex-col items-start justify-start max-w-[1951px] mt-[103px] mx-auto md:px-5 w-full">
          <div className="flex flex-col items-center justify-start w-[87%] md:w-full">
            ...
            >
              <span className="text-gray-100_02 font-inter font-bold">
                Join the{" "}
              </span>
            ...
            <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-[109px] w-full">
              ...
              >
                <div className="flex flex-col items-center justify-start sm:ml-[0] w-full">
                  <div className="bg-white-A700 flex flex-col items-center justify-end p-[31px] sm:px-5 rounded-[24px] w-full">
                    <div className="flex flex-row items-start justify-center mt-[21px] w-[73%] md:w-full">
                      <Text
                      ...
                      <Switch
                        ...
                        value={false}
                        className="border-2 border-solid ml-[9px] red_800_red_800_border3 w-[33%]"
                      />
                      <Text
                  ...
                  <div className="bg-white-A700 flex flex-col items-center justify-end p-[31px] sm:px-5 rounded-[24px] w-full">
                    <div className="flex flex-row items-start justify-center mt-[21px] w-[73%] md:w-full">
                      ...
                      <Switch
                        ...
                        offHandleColor="#c82625"
                        value={false}
                        className="border-2 border-solid ml-[9px] red_800_red_800_border6 w-[33%]"
                      />
                      <Text
                        className="ml-[7px] mt-[7px] text-base text-black-900 text-center"
                        size="txtInterMedium16"
                    ...
                    <div className="flex flex-col gap-6 items-center justify-start mt-8 w-[92%] md:w-full">
                      <div className="flex flex-col gap-2 items-center justify-start w-full">
                        ...
                        <div className="md:h-[102px] h-[161px] relative w-full">
                          ...
                          <Line className="absolute bg-gray-600 h-0.5 left-[16%] top-[44%] w-[33%]" />
                          <Text
                            className="absolute bottom-[0] inset-x-[0] mx-auto text-2xl md:text-[22px] text-center text-gray-900 sm:text-xl w-full"
                            size="txtInterRegular24"
                          >
                            <>
                              /month
